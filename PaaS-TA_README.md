...
+        log4jVersion = '2.16.0' // this pinning can be removed when we bump to a spring boot starter version that has 2.16.0+ (due to CVE https://github.com/advisories/GHSA-jfh8-c2jp-5v3q in log4j <= 2.15.0)
     }
